...
execute store result score xp tmp run data get storage core:profiles tmp.xp
tellraw @s [{"text":" ","color":"gray"},{"text":"Опыт: ","color":"blue"},{"color":"yellow","score":{"objective":"tmp","name":"xp"}},{"text":" Уровень: ","color":"blue"},{"color":"yellow","score":{"objective":"tmp","name":"level"}}]

execute store result score money tmp run data get storage core:profiles tmp.money
tellraw @s [{"text":" ","color":"gray"},{"text":"Деньги: ","color":"blue"},{"color":"yellow","score":{"objective":"tmp","name":"money"}}]
