...
# tellraw @s [{"text":"   Стр.","color":"gray"},{"text":" [ < ] ","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Перейти"}]},"clickEvent":{"action":"run_command","value":"/trigger menu set 2"}},{"text":"3 из 3","color":"gray"},{"text":" [ > ]","color":"gray"}]
