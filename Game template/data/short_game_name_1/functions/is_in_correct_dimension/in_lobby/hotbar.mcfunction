...
#ready button
    ...
    #ready mode 1
        ...
        execute if score ready_mode sgn1.settings matches 1 if score @s bool matches 1 if score teams sgn1.settings matches 1.. if entity @s[team=lobby,nbt=!{Inventory:[{Slot:2b,tag:{hotbar:1b}}]}] run function short_game_name_1:is_in_correct_dimension/in_lobby/hotbar/item1_3
        clear @s[nbt=!{Inventory:[{tag:{hotbar:1b}}]}] #core:all_items{clear:1b,hotbar:1b}
    ...
    #ready mode 2
        ...
        execute if score ready_mode sgn1.settings matches 2 if score @s bool matches 1 if score teams sgn1.settings matches 1.. if entity @s[team=lobby,nbt=!{Inventory:[{Slot:2b,tag:{hotbar:1b}}]}] run function short_game_name_1:is_in_correct_dimension/in_lobby/hotbar/item1_3
    ...
    #ready mode 3-4
        ...
        execute if score ready_mode sgn1.settings matches 3 if score @s bool matches 1 if score teams sgn1.settings matches 1.. if entity @s[team=!lobby,tag=!sgn1.ready] run function short_game_name_1:is_in_correct_dimension/in_lobby/hotbar/item1_1

        execute if score ready_mode sgn1.settings matches 4 if score @s bool matches 1 if score teams sgn1.settings matches 1.. if entity @s[tag=sgn1.ready] run function short_game_name_1:is_in_correct_dimension/in_lobby/hotbar/item1_2
        


        execute if score ready_mode sgn1.settings matches 3..4 if score @s bool matches 1 if entity @s[nbt=!{Inventory:[{Slot:2b,tag:{hotbar:1b}}]}] run function short_game_name_1:is_in_correct_dimension/in_lobby/hotbar/item1_4
        clear @s[nbt=!{Inventory:[{tag:{hotbar:1b}}]}] #core:all_items{clear:1b,hotbar:1b}
#
