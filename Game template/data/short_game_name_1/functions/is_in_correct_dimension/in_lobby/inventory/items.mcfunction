...
#Teams
    #Red
        ...
        execute if score teams sgn1.settings matches 1.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.r_red] inventory.0 with red_concrete_powder{inventory:1b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Красные","color":"red","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 1.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.nr_red] inventory.0 with red_concrete_powder{inventory:1b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Красные","color":"red","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        ...
        execute if score teams sgn1.settings matches 1.. run item replace entity @s[tag=blocked_join] inventory.0 with barrier{inventory:1b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Красные","color":"red","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 1.. run item replace entity @s[tag=blocked_leave] inventory.0 with barrier{inventory:1b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Красные","color":"red","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
    ...
    #Green
        ...
        execute if score teams sgn1.settings matches 1.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.r_green] inventory.1 with green_concrete_powder{inventory:2b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Зелёные","color":"green","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 1.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.nr_green] inventory.1 with green_concrete_powder{inventory:2b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Зелёные","color":"green","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        ...
        execute if score teams sgn1.settings matches 1.. run item replace entity @s[tag=blocked_join] inventory.1 with barrier{inventory:2b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Зелёные","color":"green","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 1.. run item replace entity @s[tag=blocked_leave] inventory.1 with barrier{inventory:2b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Зелёные","color":"green","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
    ...
    #blue
        ...
        execute if score teams sgn1.settings matches 2.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.r_blue] inventory.2 with blue_concrete_powder{inventory:3b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Синие","color":"blue","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 2.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.nr_blue] inventory.2 with blue_concrete_powder{inventory:3b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Синие","color":"blue","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        ...
        execute if score teams sgn1.settings matches 2.. run item replace entity @s[tag=blocked_join] inventory.2 with barrier{inventory:3b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Синие","color":"blue","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 2.. run item replace entity @s[tag=blocked_leave] inventory.2 with barrier{inventory:3b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Синие","color":"blue","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
    ...
    #yellow
        ...
        execute if score teams sgn1.settings matches 3.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.r_yellow] inventory.3 with yellow_concrete_powder{inventory:4b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Жёлтые","color":"yellow","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 3.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.nr_yellow] inventory.3 with yellow_concrete_powder{inventory:4b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Жёлтые","color":"yellow","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        ...
        execute if score teams sgn1.settings matches 3.. run item replace entity @s[tag=blocked_join] inventory.3 with barrier{inventory:4b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Жёлтые","color":"yellow","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 3.. run item replace entity @s[tag=blocked_leave] inventory.3 with barrier{inventory:4b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Жёлтые","color":"yellow","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
    ...
    #dark_red
        ...
        execute if score teams sgn1.settings matches 4.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.r_dark_red] inventory.4 with red_concrete{inventory:5b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-красные","color":"dark_red","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 4.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.nr_dark_red] inventory.4 with red_concrete{inventory:5b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-красные","color":"dark_red","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        ...
        execute if score teams sgn1.settings matches 4.. run item replace entity @s[tag=blocked_join] inventory.4 with barrier{inventory:5b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-красные","color":"dark_red","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 4.. run item replace entity @s[tag=blocked_leave] inventory.4 with barrier{inventory:5b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-красные","color":"dark_red","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
    ...
    #dark_green
        ...
        execute if score teams sgn1.settings matches 5.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.r_dark_green] inventory.5 with green_concrete{inventory:6b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-зелёные","color":"dark_green","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 5.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.nr_dark_green] inventory.5 with green_concrete{inventory:6b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-зелёные","color":"dark_green","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        ...
        execute if score teams sgn1.settings matches 5.. run item replace entity @s[tag=blocked_join] inventory.5 with barrier{inventory:6b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-зелёные","color":"dark_green","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 5.. run item replace entity @s[tag=blocked_leave] inventory.5 with barrier{inventory:6b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-зелёные","color":"dark_green","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
    ...
    #dark_blue
        ...
        execute if score teams sgn1.settings matches 6.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.r_dark_blue] inventory.6 with blue_concrete{inventory:7b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-синие","color":"dark_blue","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 6.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.nr_dark_blue] inventory.6 with blue_concrete{inventory:7b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-синие","color":"dark_blue","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        ...
        execute if score teams sgn1.settings matches 6.. run item replace entity @s[tag=blocked_join] inventory.6 with barrier{inventory:7b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-синие","color":"dark_blue","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 6.. run item replace entity @s[tag=blocked_leave] inventory.6 with barrier{inventory:7b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-синие","color":"dark_blue","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
    ...
    #gold
        ...
        execute if score teams sgn1.settings matches 7.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.r_gold] inventory.7 with yellow_concrete{inventory:8b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-жёлтые","color":"gold","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 7.. run item replace entity @s[tag=!blocked_all,tag=!blocked_leave,team=sgn1.nr_gold] inventory.7 with yellow_concrete{inventory:8b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-жёлтые","color":"gold","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        ...
        execute if score teams sgn1.settings matches 7.. run item replace entity @s[tag=blocked_join] inventory.7 with barrier{inventory:8b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-жёлтые","color":"gold","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
        execute if score teams sgn1.settings matches 7.. run item replace entity @s[tag=blocked_leave] inventory.7 with barrier{inventory:8b,clear:1b,Enchantments:[{}],display:{"Name":'[{"text":"Тёмно-жёлтые","color":"gold","italic":false},{"text":" [Q]","color":"gray","italic":true}]'}}
