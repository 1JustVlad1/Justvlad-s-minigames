...
tellraw @s [{"text":" ","color":"gray"},{"text":"[Быстрое тп в комнату]","color":"light_purple","hoverEvent":{"action":"show_text","contents":[{"text":"Перейти"}]},"clickEvent":{"action":"run_command","value":"/trigger helper_room"}}]
