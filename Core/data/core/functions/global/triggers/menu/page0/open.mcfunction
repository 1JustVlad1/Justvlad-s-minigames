...
execute if score @s menu matches -4400 run function short_game_name_3:triggers/menu/helper_settings/players/page1/open
execute if score @s menu matches -4600 run function short_game_name_3:triggers/menu/helper_settings/players/page2/open
execute if score @s menu matches -5400 run function short_game_name_4:triggers/menu/helper_settings/players/page1/open
execute if score @s menu matches -5600 run function short_game_name_4:triggers/menu/helper_settings/players/page2/open
execute if score @s menu matches -6400 run function short_game_name_5:triggers/menu/helper_settings/players/page1/open
execute if score @s menu matches -6600 run function short_game_name_5:triggers/menu/helper_settings/players/page2/open
execute if score @s menu matches -7400 run function short_game_name_6:triggers/menu/helper_settings/players/page1/open
execute if score @s menu matches -7600 run function short_game_name_6:triggers/menu/helper_settings/players/page2/open
execute if score @s menu matches -8400 run function short_game_name_7:triggers/menu/helper_settings/players/page1/open
execute if score @s menu matches -8600 run function short_game_name_7:triggers/menu/helper_settings/players/page2/open
execute if score @s menu matches -9400 run function short_game_name_8:triggers/menu/helper_settings/players/page1/open
execute if score @s menu matches -9600 run function short_game_name_8:triggers/menu/helper_settings/players/page2/open
execute if score @s menu matches -10400 run function short_game_name_9:triggers/menu/helper_settings/players/page1/open
execute if score @s menu matches -10600 run function short_game_name_9:triggers/menu/helper_settings/players/page2/open
